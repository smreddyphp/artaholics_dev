...
<div class="ng-scope" ng-controller="ProductCtrl" ng-app="productApp" id="productApp">
    ...
    <div class="row clearfix" ng-cloak>
        ...
        <div class="col-lg-5 col-md-4 col-sm-12 col-xs-12 editor_section">
        ...
        <div class="col-lg-7 col-md-8 col-sm-12 col-xs-12 canvas_section pull-right">
            <div class="row"> 
                ...
                <div>
                	<a ng-click="downloadObject()" href="javascript:void(0)" class="ng-scope"><button style="float: right;" id="abc" class="btn btn-primary" onclick="closewindow()">SAVE</button></a>                	 
                </div>
