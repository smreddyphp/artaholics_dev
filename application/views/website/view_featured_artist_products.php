									...
									<div class="panel panel-default">
										<div class="panel-heading" role="tab" id="headingOne">
											<h4 class="panel-title">
												<a role="button" data-toggle="collapse" data-parent="#accordion" href="#cat<?php echo @$value['cat_id'];?>" aria-expanded="<?php if(@$cat_id==@$value['cat_id']){ echo 'true'; }else{ echo 'false';}?>" aria-controls="collapseOne">
										...
										<div id="Prize" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
											<div class="panel-body">
												<div class="prize_range">													
														<input type="text" name="data[min_price]" class="form-control">
														<input type="text" name="data[max_price]" class="form-control">
														<input type="hidden" name="data[artist_id]" value="<?php echo @$artist_id;?>">
												</div> 
											</div>
										</div>
									</div>
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-inline sort_by">
											...
											<select class="form-control show_by" onchange="search_products(this.value);">
      ...
      <script> 
		...
		<script type="text/javascript">
			...
			function search_products(value)
			{
				...
				$.ajax({                
                    url: "<?php echo base_url();?>website/search_artist_items_by_periority",
                    type: "POST",
                    data: {value:value,artist_id:"<?php echo @$artist_id;?>"},                 
