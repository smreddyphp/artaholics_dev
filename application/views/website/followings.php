...
<section class="available_section artist_works">
  <div class="container">
    ...
    <div id="following" class="tab-pane active show">
      <div class="sort_box">
        <div class="row">
          <div class="col-md-5">
            <div><br>
              <h4><?php echo @$language['following'];?></h4>
            </div>
          </div>
        </div>
      </div>    
    <div class="owl-carousel owl-carousel-fav staff-list">
            <?php if(@$user_followings){ 
                foreach (@$user_followings as $key => $value) {
              ?>
              <div class="featured_div">
                  ...
                  <a href="<?php echo base_url();?>/website/featured_artist_products/<?php echo @$value['user_id'];?>"><p class="fea_art"><?php echo @@$value['first_name'];?>
