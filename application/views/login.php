			...
			<div class="col-sm-12">
				<div class="login-card card-block" style="background:white">
					<form class="md-float-material" id="loginform" method="POST" action="<?php echo base_url();?>admin/login">
						...
						<div class="text-center">Artaholics
							<img src="<?php echo base_url();?>assets/images/Logo.png" style="width:50%;margin-left:-85px;">
						</div>
					...
					<span  id="login_error_msg"></span>
						...
						<div class="md-input-wrapper">
							<input type="email" class="md-form-control" name="data[email]" value="admin@gmail.com" />
							<label>Email</label>
						</div>
						<div class="md-input-wrapper">
							<input type="password" class="md-form-control" name="data[password]" value="123456" />
						...
						<div class="row">
							...
							<div class="col-sm-6 col-xs-12 forgot-phone text-right">
								<a href="<?php echo base_url();?>home/forgot_password"  class="text-right f-w-600"> Forget Password?</a>
								</div>
						</div>
						<div class="row">
