...
.factory('Fabric', [
	...
	return function(options) {
        ...
        fabric.Object.prototype.customiseCornerIcons( {
            ...
            tl: {
                icon: 'http://localhost/artaholics_dev/assets/design/images/icons/rotate.jpg'
            },
            tr: {
                icon: 'http://localhost/artaholics_dev/assets/design/images/icons/resize.jpg'
            },
            bl: {
                icon: 'http://localhost/artaholics_dev/assets/design/images/icons/delete.png'
            },
            br: {
                icon: 'http://localhost/artaholics_dev/assets/design/images/icons/move.jpg'
            },
            mb: {
                icon: 'http://localhost/artaholics_dev/assets/design/images/icons/move.jpg'
            },
       ...
       /***************** for corner icons  ****************/
		...
		self.addObjectToCanvas = function(object) {
			...
			object.originalScaleX = .10 ; //object.scaleX;
			object.originalScaleY = .10 ; //object.scaleY;
			object.originalLeft   =  50 ; //object.left;
			object.originalTop    =  50 ; //object.top;
		...
		self.addImage = function(imageURL) {
            ...
            /*var backimg = canvas.backgroundImage;

            var height = backimg.height ;
            var width  = backimg.width ;

            //console.log(width);

            //self.setCanvasSize(600, 600);*/
		};
        ...
        self.downloadCanvasObject = function() {
            ...
            $.ajax({
                method: 'post',
                url: "http://localhost/artaholics_dev/Design/get_canvas_image",
                data: {'data':data},
